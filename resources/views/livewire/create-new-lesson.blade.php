                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div wire:ignore class="form-group"> 
                                    ...
                                    <select wire:model.defer="state.unit_id" name="unit_id" class="form-control">
                                ...
                                <div class="white_shd full margin_bottom_30">
                                    ...
                                    <div class="col-md-12">
                                        <div wire:ignore.self class="form-group">
                                            ...
                                            <textarea wire:model.defer="state.objectives" class="form-control" id="objectives" name="objectives"></textarea>
                                            @error('objectives') <span >{{ $message }}</span> @enderror
                                        </div>
                                        <div wire:ignore class="form-group">
                                            <label for="teaching_resource">Teaching Resources</label>
                                            <textarea wire:model.defer="state.teaching_resource" class="form-control" id="teaching_resource" name="teaching_resource"></textarea>
